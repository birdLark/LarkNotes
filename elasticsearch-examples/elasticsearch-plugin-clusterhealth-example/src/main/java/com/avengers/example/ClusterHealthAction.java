...
public class ClusterHealthAction  extends AbstractCatAction {

    public ClusterHealthAction(Settings settings) {
        super(settings);
    }

    public  ClusterHealthAction(Settings settings, RestController controller) {
        super(settings);
        controller.registerHandler(GET, "/_cat/healths", this);
    }
